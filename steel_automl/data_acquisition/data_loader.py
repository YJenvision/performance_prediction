...
class DataLoader:
    ...
    def fetch_data(self, sg_sign: Optional[List[str]], target_metric: str, time_range: str,
                   product_unit_no: Optional[List[str]], st_no: Optional[List[str]]) -> Optional[pd.DataFrame]:
        """
    ...
    def fetch_data_from_excel(self, sg_sign, target_metric, time_range, product_unit_no, st_no) -> Optional[
        pd.DataFrame]:
        """从Excel文件获取数据。"""
