...
if __name__ == "__main__":
    ...
    example_requests_for_direct_test = [
        ...
        # "用过去一年的数据构建一个H031机组的LA和CM钢种抗拉强度性能预报模型，使用XGBOOST，用贝叶斯优化方法利用R2进行超参数优化，快速验证建模方案，不需要对异常值进行判别和处理。",
        "用过去两年的数据构建一个H033机组的抗拉强度性能预报模型，使用XGboost，用贝叶斯优化进行超参数优化，尽可能使得模型效果好，不需要对异常值进行判别和处理。",
