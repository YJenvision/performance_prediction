...
if __name__ == "__main__":
    ...
    example_requests_for_direct_test = [
        "用Q235B牌号过去十年的全部数据构建一个抗拉强度预报模型，使用XGboost，用贝叶斯优化利用R2进行超参数优化，尽可能使得模型效果好，对缺失值超过50%的特征列的对应数据样本进行删除，而不是删除特征列，我的可接受误差浮动是正负20以内，不需要进行异常值的识别和处理",
